...
async function importEventbriteEvents() {
  try {
    ...
    // Read the JSON file
    const filePath = join(__dirname, '../../manual-import-templates/eventbrite-events-nov2025.json');
    const fileContent = readFileSync(filePath, 'utf-8');
    const events = JSON.parse(fileContent);

    console.log(`📋 Found ${events.length} Eventbrite events to import\n`);
